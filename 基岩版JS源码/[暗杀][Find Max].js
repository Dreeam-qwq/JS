    ...
    try {
        ...
        use1.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                ...
                clientMessage("§4你可以撸基岩了∪•\u3c9•∪");
            }
        }))
        layout.addView(use1)

        var use5 = new android.widget.Button(ctx)
        use5.setText("生存撸命令方块")
        use5.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                ...
                clientMessage("§4你可以撸命令方块了了∪•\u3c9•∪");
            }
        }))
        layout.addView(use5)
...
function 顶部提示(text) {
    ...
    ctx.runOnUiThread(new java.lang.Runnable({
        run: function() {
            var 文字 = NewText("暗杀Find XS•" + text, "LC", 14, "#FFAA00");
            lay.addView(文字);
