//此版本是
//『PE最强外挂』Skiddy_v5『陌』二次魔改_latest.js
//的更新版本
//谢谢大家加载此js
//=============================//
//QQ交流群:858569055
...
//改大踏空距离
//改大上下瞬移距离
//新增'设''回'按钮,并且加上skiddy的UI
//新增快捷飞行按钮,并且加上skiddy的UI
//修复按钮重叠的BUG
//修复主界面弹窗的红色多余UI的BUG
//快捷传送:点击'设'来记录当前坐标,点击'回'即可传送回来
//快捷飞行:只实用于AAC比较低的服务器
//有任何想在里面加入都可以联系
//QQ923736602或者发QQ邮箱Mo@qq.com
//解密你马呢
//感谢 @南风 大佬付出
//魔改:我的丿心语
//QQ:3298537709
...
ModPE['langEdit']('menu.copyright', '§4Skiddy§6黑客端: §e84插件已加载，汉化:心语');
...
var spamDelay = 3500;
var ln = 0;
var spamText = '请在聊天栏输入!spam <本文>来刷屏';
var hitjumps;
var hitjumpss = false;
var hitjumped = false;
var longhops;
...
ctx.runOnUiThread(new java.lang.Runnable({
    run: function() {
        ...
        button.setOnClickListener(new android.view.View.OnClickListener() {
            onClick: function(v) {
                Entity.setPosition(getPlayerEnt(), Player.getX(), Player.getY() + 1.8, Player.getZ())
                Player.setFlying(true)
                clientMessage("§4飞行绕过检测已开启")
                fctoast("不要在AAC高的服务器开哦") //new
            }
        });
        ...
        win.setWidth(120);
        win.setHeight(110);
        win.showAtLocation(ctx.getWindow().getDecorView(), android.view.Gravity.RIGHT | android.view.Gravity.TOP, 180, 200); //new
    }
}));
//来自null
//传送大法
...
ctx.runOnUiThread(new java.lang.Runnable({
    run: function() {
        ...
        win.setWidth(120);
        win.setHeight(110);
        win.showAtLocation(ctx.getWindow().getDecorView(), android.view.Gravity.RIGHT | android.view.Gravity.TOP, 1500, 100); //new
    }
}));
...
ctx.runOnUiThread(new java.lang.Runnable({
    run: function() {
        ...
        button.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(viewarg) {
                if (xxx == null) {
                    clientMessage("§4传送失败 §3未设置传送点")
                    fctoast("你确定按过'设'了?") //new
                } else {
        ...
        win.setWidth(120);
        win.setHeight(110);
        win.showAtLocation(ctx.getWindow().getDecorView(), android.view.Gravity.RIGHT | android.view.Gravity.TOP, 1790, 100); //new
    }
}));
    ...
    ctx.runOnUiThread(new java.lang.Runnable({
        run: function() {
            try {
                ...
                tosLayout1.addView(tosScroll); //new
                //已删除一段代码
                ...
                var tosInfo = new TextView(ctx);
                tosInfo.setTextSize(15);
                tosInfo.setText("如有什么建议都可以QQ联系我");
                tosInfo.setTextColor(android.graphics.Color.WHITE);
                tosInfo.setBackgroundDrawable(new android.graphics.drawable.ColorDrawable(android.graphics.Color.BLACK));
                tosInfo.getBackground().setAlpha(150);
                tosInfo.setGravity(Gravity.CENTER);
                ...
                var tosInfo = new TextView(ctx);
                tosInfo.setTextSize(15);
                tosInfo.setText("QQ群:257822644(满了加群主QQ)");
                tosInfo.setTextColor(android.graphics.Color.WHITE);
                tosInfo.setBackgroundDrawable(new android.graphics.drawable.ColorDrawable(android.graphics.Color.BLACK));
                tosInfo.getBackground().setAlpha(150);
                tosInfo.setGravity(Gravity.CENTER);
    ...
    ctx['runOnUiThread'](new Runnable({
        run: function() {
            try {
                ...
                _0x2bf6x134['setTextSize'](38);
                _0x2bf6x134['setTextColor'](Color['rgb'](255, 0, 255));
                _0x2bf6x134['setBackground'](theme);
        ...
        run: function() {
            try {
                ...
                _0x2bf6x136['setOnClickListener'](new View.OnClickListener({
                    onClick: function(_0x2bf6x132) {
                        Entity['setPositionRelative'](getPlayerEnt(), 0, +8, 0)
                    }
                }));
                ...
                _0x2bf6x137['setOnClickListener'](new View.OnClickListener({
                    onClick: function(_0x2bf6x132) {
                        Entity['setPosition'](getPlayerEnt(), getPlayerX(), getPlayerY() - 5, getPlayerZ())
                    }
                }));
    ...
    ctx['runOnUiThread'](new Runnable({
        run: function() {
            try {
                ...
                GUIz['showAtLocation'](ctx['getWindow']()['getDecorView'](), Gravity['LEFT'] | Gravity['TOP'], 3, 250)
            } catch (err) {
                Toast['makeText'](ctx, 'An error occured: ' + err, 1)['show']()
            }
        }
    ...
    ctx['runOnUiThread'](new Runnable({
        run: function() {
            try {
                ...
                scrollText.setText("作者:Koikoi,魔改:XinYu404");
                                ...
                                switchreachs['setOnCheckedChangeListener'](new android['widget']['CompoundButton'].OnCheckedChangeListener({
                                    onCheckedChanged: function() {
                                        if (!switchreached) {
                                            showReachSwitch();
                                            switchreached = true
                                            fctoast('XinYu:真正的长臂猿是reach，而不是hitbox 他是通过切换模式来改变距离的，所以在服务器无效')
...
function chatHook(_0x2bf6x25) {
    ...
    if (_0x2bf6x1a7[0] == '!info') {
        ...
        clientMessage(fct + 'Translator: Kik @wo de Pie xin yu, Email: wodepiexinyu@gmail.com');
    ...
    try {
        ...
        ctx['runOnUiThread'](new java['lang'].Runnable({
            run: function() {
                ...
                _0x2bf6x1b4['setStroke'](2.8, android['graphics']['Color']['rgb'](255, 128, 0));
