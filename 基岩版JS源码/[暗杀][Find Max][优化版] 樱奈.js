...
var 公告 = FontColor(
    "暗杀Find系列" + JS注释 + "\n当前JS版本" + JS版本 + "\n\n" + "§l§1|JS简介|§c#0§r\n暗杀Find " + JS版本 + " 暗杀Find系列js基于暗杀Pro上添加功能，" + "是一个综合JS，各类功能都有。" + "使用本JS代表您已同意以下一点:" + "使用者自行承担使用本JS的后果。" + "Find X以上功能为" + JS作者 + "添加，" + "如有更好的建议，请加Q" + 作者QQ + "\n\n\n§l§1|更新内容|§c#1§r\nFind XS→Find MAX\n" + "1.增加撸方块功能\n" + "2.新增撸基岩功能\n" + "3.新增撸黑曜石\n" + "4.新增撸末地折跃门\n" + "5.新增撸末地传送门\n" + "6.新增撸末地石\n" + "7.新增秒撸刷怪笼\n" + "8.新增秒撸各类石头\n" + "9.新增秒撸各类木板\n" + "10.一键拿物品增加三种崩服蛋\n" + "11.增加回血功能\n" + "12.增加血量清零功能\n" + "13.增加时间管理功能(自娱)\n" + "14.删除音乐播放器\n" + "15.修复调整了一些BUG\n" + "\n\n\n§l§1|更新内容|§c#2§r\nFind X→Find XS\n" + "1.增加无限闪杀(可能会比环杀快)\n" + "2.修复环绕暗杀BUG，改为无限环绕暗杀\n" + "3.修复背后暗杀BUG，改为无限背后暗杀\n" + "4.增加添加物品\n" + "5.增加虚空回弹\n" + "6.增加随机传送\n" + "7.修复音乐播放器\n" + "8.更改字体颜色为橙色\n" + "9.刷物改为一键拿物品\n" + "10.一键拿物品增加更多物品\n" + "11.更新物品表，方块表\n" + "12.增加药水表，附魔箭表\n" + "13.修复设家的BUG\n" + "14.去除动态效果\n" + "15.功能归类\n" + "16.修复一些小BUG\n" + "倒卖狗真*死全家！\n" + "\n\n\n§l§1|更新内容|§c#3§r\nFind W→Find X\n" + "1.增加远程联网下载源码\n" + "2.增加框架透视\n" + "3.新增音乐播放器\n" + "4.彩字高清显示\n" + "5.修复绑/绕的BUG\n" + "\n\n\n§l§1|更新内容|§c#4§r\nFind V→find W\n" + "1.增加自动长臂，" + "对10格范围内的所有玩家有效。\n" + "2.减慢按钮拖动速度（与微端速度一致)\n" + "3.增加虚空漫游，" + "循环设置y轴速度为0(如出现缓慢下掉，属于正常情况)\n" + "4.修改刷物界面，支持快速刷物\n" + "5.修改药水添加方式\n" + "6.增加定位坐标功能(无法记录坐标）\n" + "7.增加了黑洞杀(仅联机可用)\n" + "8.更改暗杀按钮样式（图形、可拖动)\n" + "9.增加了公告界面\n\n\n" + "本JS永久免费！");
    ...
    ctx.runOnUiThread(new java.lang.Runnable({
        run: function() {
            try {
                ...
                t1 = NewText("原作digyth", "CC", 18, "#FFAA00");
                vn1.addView(t1);
...
function 撸方块() {
    ...
    try {
        ...
        var use2 = new android.widget.Button(ctx)
        use2.setText("秒撸黑曜石")
        use2.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                Block.setDestroyTime("49", "0");
                clientMessage("§6你可以秒撸黑曜石了");
            }
        }))
        layout.addView(use2)
        ...
        var use3 = new android.widget.Button(ctx)
        use3.setText("秒撸末地石")
        use3.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                Block.setDestroyTime("121", "0");
                clientMessage("§6你可以秒撸末地石了");
            }
        }))
        layout.addView(use3)
        ...
        var use4 = new android.widget.Button(ctx)
        use4.setText("秒撸各类石头")
        use4.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                Block.setDestroyTime("1", "0");
                clientMessage("§6你可以秒撸各类石头了");
            }
        }))
        layout.addView(use4)
        ...
        var use5 = new android.widget.Button(ctx)
        use5.setText("撸末地传送门")
        use5.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                Block.setDestroyTime("119", "0");
                clientMessage("§6你可以末地传送门了");
            }
        }))
        layout.addView(use5)
        ...
        var use6 = new android.widget.Button(ctx)
        use6.setText("撸末地折跃门")
        use6.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                Block.setDestroyTime("209", "0");
                clientMessage("§6你可以撸末地折跃门了");
            }
        }))
        layout.addView(use6)
        ...
        var use7 = new android.widget.Button(ctx)
        use7.setText("秒撸各类木板")
        use7.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                Block.setDestroyTime("5", "0");
                clientMessage("§6你可以各类木板了");
            }
        }))
        layout.addView(use7)
        ...
        var use8 = new android.widget.Button(ctx)
        use8.setText("秒撸刷怪笼")
        use8.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(v) {
                Block.setDestroyTime("52", "0");
                clientMessage("§6你可以秒撸刷怪笼了");
            }
        }))
        layout.addView(use8)
        ...
        menu.showAtLocation(ctx.getWindow().getDecorView(), android.view.Gravity.RIGHT | android.view.Gravity.TOP, dip2px(ctx, 151), dip2px(ctx, 100))
    } catch (err) {
        print(err)
    }
...
function 顶部提示(text) {
    ...
    ctx.runOnUiThread(new java.lang.Runnable({
        run: function() {
            var 文字 = NewText("暗杀Find Max•" + text, "LC", 14, "#FFAA00");
            lay.addView(文字);
            ...
            Ui(function() {
                ...
                addButton(lay1, "方框透视", function() {
                    if (方框透视) {
                        ...
                        start();
                        顶部提示(FontColor("§3方框透视开启，可能会造成卡顿"));
                        方框透视 = true;
                    }
                }, null, 0, 15, true);
                ...
                addButton(lay1, "撸方块", function() {
                    撸方块();
                }, null, 0, 15, true);
                addButton(lay1, "时间管理", function() {
                    时间管理();
                }, null, 0, 15, true);
...
function zhuye() {
    ctx.runOnUiThread(new java.lang.Runnable({
        run: function() {
            try {
                android.widget.Toast.makeText(ctx, "请选择QQ方式", 400).show();
                webView = new android.webkit.WebView(ctx);
                webView.getSettings().setJavaScriptEnabled(true);
                webView.getSettings().setAllowFileAccess(true);
                webView.getSettings().setBuiltInZoomControls(true);
                webView.loadUrl("http://jq.qq.com/?_wv=1027&k=hIHDOO");
            } catch (e) {
                print(e);
            }
        }
