    ...
    run: function() {
        ...
        button.setOnClickListener(new android.view.View.OnClickListener() {
            onClick: function(v) {
                ...
                clientMessage("专属飞行，稳定奔放。花雨庭不摔血版！              §4QQ1953336481\n§a残§b梦§3牛逼§1  牛逼\n\n§2残梦 QQ1953336481")
            }
        });
    ...
    run: function() {
        ...
        button.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(viewarg) {
                ...
                yyy = Player.getY()
                zzz = Player.getZ()
                clientMessage("§a残§b梦§3牛逼：§5时空传送点设置完毕，随时准备时空传送！ ")
            }
        }))
        layout.addView(button);
        win.setContentView(layout);
...
ctx.runOnUiThread(new java.lang.Runnable({
    run: function() {
        ...
        button.setOnClickListener(new android.view.View.OnClickListener({
            onClick: function(viewarg) {
                if (xxx == NaN) {
                    clientMessage("§§a残§b梦§3牛逼：§5传送失败，未设置传送点时空未发现漏洞。")
                } else {
                    setPosition(getPlayerEnt(), xxx, yyy, zzz)
                    clientMessage("\n\n§1残§b梦§3牛逼：§2时空裂痕已经打开，传送完毕！§4（绕系统）")
                }
            }
        }))
        layout.addView(button);
        ...
        win.setHeight(80);
        win.setBackgroundDrawable(new android.graphics.drawable.ColorDrawable(android.graphics.Color.argb(128, 18, 3, 66)))
        win.showAtLocation(ctx.getWindow().getDecorView(), android.view.Gravity.RIGHT | android.view.Gravity.TOP, 1990, 100);
    }
}));
...
ModPE['langEdit']('menu.copyright', '§4white§6white黑客端: §e81插件已注入网易我的世界。');
...
var clr = '§';
var fct = '§l§4[§r§6White§l§4§l]§r§6: ';
var team = new Array();
var leaveG = true;
var VERSION = 'V1.0';
var NAME = 'white ';
        ...
        run: function() {
            try {
                ...
                if (stealthss) {
                    ...
                    _0x2bf6x131['setText'](' White V1.0 ')
                };
                _0x2bf6x131['setTextColor'](android['graphics']['Color']['rgb'](0, 128, 10));
    ...
    ctx['runOnUiThread'](new Runnable({
        run: function() {
            try {
                ...
                _0x2bf6x13e['setTextOn']('自瞄已部署ὠf�');
                _0x2bf6x13e['setTextOff']('自瞄已就绪');
    ...
    ctx['runOnUiThread'](new Runnable({
        run: function() {
            try {
                ...
                scrollText.setText("By. Qq: 1953336481    ὄ9�欢迎加入PE网易·残梦我的世界内部群：974360076                                 ~原作者：Koikoi");
                        ...
                        run: function() {
                            try {
                                ...
                                _0x2bf6x159['setOnClickListener'](new View.OnClickListener({
                                    onClick: function(_0x2bf6x132) {
                                        ccrash();
                                        fctoast('残梦 white已注入，赶快到服务器里游玩吧！')
                                    }
                                }));
...
function chatHook(_0x2bf6x25) {
    ...
    if (_0x2bf6x1a7[0] == '!team') {
        ...
        if (_0x2bf6x1a7[1] == 'remove' && _0x2bf6x1a7[2] != 'XinYu404') {
            ...
            if (_0x2bf6x1a7[2] == '我没有开挂') {
                clientMessage(fct + '你不能删除我没有开挂队友')
            };
            preventDefault()
        }
    };
...
' + ' z: ' + Math['floor'](Entity['getZ'](_0x2bf6x166)), '附近玩家')
                        }
                    };
                    nx = getPlayerX();
                    ny = getPlayerY();
